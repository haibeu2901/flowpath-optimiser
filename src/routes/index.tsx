...
import { demoScenarios, products, TODAY, warehouses } from "@/data/mockData";
import {
  evaluateTransfer,
  formatNum,
...
function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold leading-tight">
                Hệ thống điều chuyển FMCG hạn sử dụng ngắn
              </h1>
              <p className="text-sm opacity-85">
                Tối ưu tuyến vận chuyển bằng Dijkstra · Chọn lô theo FEFO · Ràng buộc HSD tối thiểu
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-4 p-4 xl:grid-cols-[3fr_2fr]">
